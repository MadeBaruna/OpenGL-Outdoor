...
static Mesh* Box() {
	Vertex bodyVertices[] = {
		...
		Vertex(glm::vec3(0.5, 0.7, 0.5), glm::vec2(1.0, 1.0)),		// 2 top right
		Vertex(glm::vec3(-0.5, 0.7, 0.5), glm::vec2(0.0, 1.0)),		// 3 top left

		// right
		Vertex(glm::vec3(0.5, -0.5, 0.5), glm::vec2(0.0, 0.0)),		// 4
		Vertex(glm::vec3(0.5, -0.5, -0.5), glm::vec2(1.0, 0.0)),	// 5
		Vertex(glm::vec3(0.5, 0.7, -0.5), glm::vec2(1.0, 1.0)),		// 6
		Vertex(glm::vec3(0.5, 0.7, 0.5), glm::vec2(0.0, 1.0)),		// 

		// left
		Vertex(glm::vec3(-0.5, -0.5, 0.5), glm::vec2(0.0, 0.0)),	// 8
		Vertex(glm::vec3(-0.5, -0.5, -0.5), glm::vec2(1.0, 0.0)),	// 9
		Vertex(glm::vec3(-0.5, 0.7, -0.5), glm::vec2(1.0, 1.0)),	// 10
		Vertex(glm::vec3(-0.5, 0.7, 0.5), glm::vec2(0.0, 1.0)),		// 11

		// top
		Vertex(glm::vec3(-0.5, 0.7, -0.5), glm::vec2(0.0, 0.0)),	// 12
		Vertex(glm::vec3(0.5, 0.7, -0.5), glm::vec2(1.0, 0.0)),		// 13
		Vertex(glm::vec3(0.5, 0.7, 0.5), glm::vec2(1.0, 1.0)),		// 14
		Vertex(glm::vec3(-0.5, 0.7, 0.5), glm::vec2(0.0, 1.0)),		// 15
		...
		Vertex(glm::vec3(0.5, 0.7, -0.5), glm::vec2(1.0, 1.0)),		// 22
		Vertex(glm::vec3(-0.5, 0.7, -0.5), glm::vec2(0.0, 1.0)),	// 23
	};
